...
void disasm_one(u8* buf, int len)
{
	...
	for(j=0;j<len;j++)
	{
		...
		else if((0x0f == p[0])&&(0x84 == p[1]))
		{
			printf("jz 0x%x\n", *(int*)(p+2) + (j+6));
			j += 5;
		}
		else if((0x0f == p[0])&&(0x85 == p[1]))
		{
			printf("jnz 0x%x\n", *(int*)(p+2) + (j+6));
			j += 5;
		}
		else if((0x0f == p[0])&&(0x86 == p[1]))
		{
			printf("jna 0x%x\n", *(int*)(p+2) + (j+6));
			j += 5;
		}
		else if((0x0f == p[0])&&(0x87 == p[1]))
		{
			printf("ja 0x%x\n", *(int*)(p+2) + (j+6));
			j += 5;
		}
		else if((0x0f == p[0])&&(0x8e == p[1]))
		{
			printf("jng 0x%x\n", *(int*)(p+2) + (j+6));
			j += 5;
		}
		else if((0x0f == p[0])&&(0x8f == p[1]))
		{
			printf("jng 0x%x\n", *(int*)(p+2) + (j+6));
			j += 5;
		}
...
/*
		else if((0x29 == p[0])&&(0xd0 == p[1]))
		{
			printf("eax-edx\n");
			j += 1;
		}
		else if((0x29 == p[0])&&(0xf2 == p[1]))
		{
			printf("edx-esi\n");
			j += 1;
		}
*/
		else if((0x31 == p[0])&&(0xc0 == p[1]))
		{
			printf("eax=0\n");
			j += 1;
		}
		else if((0x31 == p[0])&&(0xc9 == p[1]))
		{
			printf("ecx=0\n");
			j += 1;
		}
		else if((0x31 == p[0])&&(0xd2 == p[1]))
		{
			printf("edx=0\n");
			j += 1;
		}
		else if((0x31 == p[0])&&(0xff == p[1]))
		{
			printf("edi=0\n");
			j += 1;
		}
		...
		else if((0x41 == p[0])&&(0x89 == p[1])&&(0xc0 == (p[2]&0xf8)))
		{
			printf("r%dd=eax\n", 8+(p[2]&0x7));
			j += 2;
		}
		else if((0x41 == p[0])&&(0x89 == p[1])&&(0xf3 == p[2]))
		{
			printf("r11d=esi\n");
			j += 2;
		}
		...
		else if((0x44 == p[0])&&(0x89 == p[1])&&(0xcf == p[2]))
		{
			printf("edi=r9d\n");
			j += 2;
		}
		else if((0x44 == p[0])&&(0x89 == p[1])&&(0xe8 == (p[2]&0xf8)))
		{
			printf("%s=r13d\n", reg32[p[2]&0x7]);
			j += 2;
		}
		...
		else if((0x45 == p[0])&&(0x31 == p[1])&&(0xed == p[2]))
		{
			printf("r13d=0\n");
			j += 2;
		}
		else if((0x45 == p[0])&&(0x85 == p[1])&&(0xed == p[2]))
		{
			printf("test r13d,r13d\n");
			j += 2;
		}
		else if((0x45 == p[0])&&(0x8d == p[1])&&(0x6f == p[2]))
		{
			printf("r13d=r15+0x%x\n", p[3]);
			j += 3;
		}
		...
		else if((0x48 == p[0])&&(0x01 == p[1])&&(0xd7 == p[2]))
		{
			printf("rdi+rdx\n");
			j += 2;
		}
		...
		else if((0x48 == p[0])&&(0x39 == p[1])&&(0xc0 == (p[2]&0xf8)))
		{
			printf("%s?rax\n", reg64[p[2]&0x7]);
			j += 2;
		}
		...
		else if((0x48 == p[0])&&(0x83 == p[1])&&(0xc0 == (p[2]&0xf0)))
		{
			printf("%s+%x\n", reg64[p[2]&0x7], p[3]);
			j += 3;
		}
		else if((0x48 == p[0])&&(0x83 == p[1])&&(0xec == p[2]))
		{
			printf("rsp-%x\n", p[3]);
			j += 3;
		}
		else if((0x48 == p[0])&&(0x83 == p[1])&&(0xf8 == p[2]))
		{
			printf("rax?0x%x\n", p[3]);
			j += 3;
		}
	...
	*/
		...
		else if((0x48 == p[0])&&(0xc1 == p[1])&&(0xe0 == p[2]))
		{
			printf("rax<<%x\n",p[3]);
			j += 3;
		}
		...
		else if((0x49 == p[0])&&(0x63 == p[1])&&(0xc5 == p[2]))
		{
			printf("rax=r13d\n");
			j += 2;
		}
		else if((0x49 == p[0])&&(0x63 == p[1])&&(0xf7 == p[2]))
		{
			printf("rsi=r15d\n");
			j += 2;
		}
		...
		else if((0x4c == p[0])&&(0x01 == p[1])&&(0xe0 == (p[2]&0xf8)))
		{
			printf("%s+r12\n", reg64[p[2]&0x7]);
			j += 2;
		}
		...
		else if((0x80 == p[0])&&(0xf9 == p[1]))
		{
			printf("cl?0x%x\n", p[2]);
			j += 2;
		}
		else if((0x81 == p[0])&&(0xfb == p[1]))
		{
			printf("ebx?0x%x\n", *(u32*)(p+2));
			j += 5;
		}
		...
		else if((0x85 == p[0])&&(0xc0 == p[1]))
		{
			printf("test eax,eax\n");
			j += 1;
		}
		else if((0x85 == p[0])&&(0xf6 == p[1]))
		{
			printf("test esi,esi\n");
			j += 1;
		}
		...
		else if((0x8d == p[0])&&(0x70 == (p[1]&0xf8)))
		{
			if(p[2] < 0x80)printf("esi=%s+0x%x\n", reg64[p[1]&0x7], p[2]);
			else printf("esi=%s-0x%x\n", reg64[p[1]&0x7], 0x100-p[2]);
			j += 2;
		}
		else if((0x8d == p[0])&&(0x78 == (p[1]&0xf8)))
		{
			if(p[2] < 0x80)printf("edi=%s+0x%x\n", reg64[p[1]&0x7], p[2]);
			else printf("edi=%s-0x%x\n", reg64[p[1]&0x7], 0x100-p[2]);
			j += 2;
		}
